...
import { ArrowLeft, Mail, Send, CheckCircle, User, MessageSquare } from 'lucide-react';
    ...
    return (
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Invitation Sent Successfully!</h1>
          
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
            <div className="text-left space-y-2">
              <p className="text-green-800">
                <strong>Recipient:</strong> {formData.name || 'New Client'} ({formData.email})
              </p>
              <p className="text-green-800">
          ...
          <p className="text-gray-600 mb-6">
            The client will receive an email with instructions to set up their account and access the portal.
          </p>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex items-center space-x-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Invite Client/Partner</h1>
          <p className="text-gray-600">Send a formal invitation to onboard a new client or partner</p>
        </div>
      </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <div className="flex items-center space-x-3 mb-4 pb-3 border-b border-gray-200">
                ...
                <div>
                  <p className="font-medium text-gray-900">Client Portal Invitation</p>
