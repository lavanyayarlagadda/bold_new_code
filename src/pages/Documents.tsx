    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {filteredDocuments.map((doc) => {
          ...
          return (
            <div key={doc.id} className="bg-white rounded-lg border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all p-4">
              ...
              <h3 className="font-medium text-gray-900 mb-2 line-clamp-2" title={doc.originalName}>
                {doc.originalName}
              </h3>
